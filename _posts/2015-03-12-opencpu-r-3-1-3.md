...
To list the versions of other R packges included with the cloud server have a look at the [opencpu-lib](https://github.com/jeroenooms/opencpu-server/tree/v1.4.6/opencpu-lib) directory on Github or nativagate to [`/ocpu/info`](http://public.opencpu.org/ocpu/info) on your opencpu server.
